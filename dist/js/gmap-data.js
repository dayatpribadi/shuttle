...
$(function () {
	...
	if( $('#map_canvas3').length > 0 ){	
		var settings = {
			zoom: 16,
			center: new google.maps.LatLng(-3.2500977744643813,104.65494600555544),
			mapTypeControl: true,
			scrollwheel: true,
			draggable: true,
			panControl:true,
			...
			var map = new google.maps.Map(document.getElementById("map_canvas3"), settings);	
			...
			var busIcon = L.icon({
				iconUrl: 'img/bus.png',
				iconSize: [38, 38], // Size int from which the popup should open relative to the iconAnchor
			});
			
			var infowindow = new google.maps.InfoWindow();	
			var companyPos = new google.maps.LatLng(-3.2500977744643813,104.65494600555544);	
